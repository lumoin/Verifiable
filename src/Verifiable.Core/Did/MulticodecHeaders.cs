...
namespace Verifiable.Core
{
    ...
    public static class MulticodecHeaders
    {
        ...
        /// <summary>
        /// Secp256k1-pub (0xe7). See more at <see href="https://github.com/multiformats/multicodec/blob/master/table.csv#L90">Secp256k1 public key (compressed) (GitHub)</see>.
        /// </summary>
        /// <remarks>Status: draft.</remarks>
        public static ReadOnlySpan<byte> Secp256k1PublicKey => new byte[] { 0xe7, 0x01 };

        /// <summary>
        /// Bls12_381-g2-pub (0xea). See more at <see href="https://github.com/multiformats/multicodec/blob/master/table.csv#L92">BLS12-381 public key in the G2 field (GitHub)</see>.
        /// </summary>
        /// <remarks>Status: draft.</remarks>
        public static ReadOnlySpan<byte> Bls12381G2PublicKey => new byte[] { 0xea, 0x01 };
