...
{
    /// <summary>
    /// Constants used in <see cref="DidDocument"/> to describe cryptographic suite material suite and method.
    /// </summary>
    public static class CryptoSuiteConstants
    {
        ...
        //See more at <see href="https://github.com/dotnet/aspnetcore/blob/main/src/Http/Http.Abstractions/src/HttpMethods.cs#L9"/>.
        ...
        /// <summary>
        /// The Signature Suite utilizes Detached JWS signatures to provide support for a subset of the digital signature algorithms registered with IANA.
        /// </summary>
