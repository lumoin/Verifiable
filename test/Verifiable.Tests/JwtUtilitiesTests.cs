...
namespace Verifiable.Tests
{
    public class JwtUtilitiesTests
    {
        /* ReadOnlySpan<byte> RsaExponent65537 = new byte[] { 0x01, 0x00, 0x01 };
           var e = Base64UrlEncoder.Encode(RsaExponent65537.ToArray());
           Assert.Equal("AQAB", e);
        */
        ...
        public void RfcRsaTestVector()
        {
            ...
            var thumbPrintBytes = JwtUtilities.ComputeRsaThumbprint(e, kty, n);
        ...
        //that agree with the implementation in this library based on the RFC. It reassures the tests function
        //as they should and test the right things.
        ...
        public void Ed25519LdsJws2020OkpCryptoSuiteExample()
        {
            ...
            var thumbPrintBytes = JwtUtilities.ComputeEcdhThumbprint(crv, kty, x);
        ...
        public void Secp256k1EcLdsJws2020CryptoSuiteExample()
        {
            ...
            var thumbPrintBytes = JwtUtilities.ComputeECThumbprint(crv, kty, x, y);
